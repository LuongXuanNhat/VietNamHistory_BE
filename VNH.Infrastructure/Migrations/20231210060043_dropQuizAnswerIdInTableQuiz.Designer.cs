...
namespace VNH.Infrastructure.Migrations
{
    ...
    [Migration("20231210060043_dropQuizAnswerIdInTableQuiz")]
    partial class dropQuizAnswerIdInTableQuiz
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VNH.Domain.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 10, 13, 0, 43, 228, DateTimeKind.Local).AddTicks(1346),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 10, 13, 0, 43, 228, DateTimeKind.Local).AddTicks(1356),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 10, 13, 0, 43, 228, DateTimeKind.Local).AddTicks(1358),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 10, 13, 0, 43, 228, DateTimeKind.Local).AddTicks(1360),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 10, 13, 0, 43, 228, DateTimeKind.Local).AddTicks(1366),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 10, 13, 0, 43, 228, DateTimeKind.Local).AddTicks(1368),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 10, 13, 0, 43, 228, DateTimeKind.Local).AddTicks(1370),
            ...
            modelBuilder.Entity("VNH.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "52be16be-c7dd-4d91-bd9a-d6f9a039171b",
                            Name = "admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "216c436b-6ee3-4e32-a97a-53d7ce990d37",
                            Name = "teacher",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "891b01e2-8b5e-4bfa-90e7-b255ea9a01cf",
                            Name = "student",
            ...
            modelBuilder.Entity("VNH.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "abb326f4-51ea-4278-abe3-92ce4a8102c9",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKBCzIxoXws/qUvTkOgJOoAoJ6z+eXE5s1eHrE52wk1ChYbz4JNPfHgXk879IIRmog==",
